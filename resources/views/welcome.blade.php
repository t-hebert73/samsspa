...
<section class="contact padded" id="contact">
    <div class="container">
        ...
        <div class="contact-info">
            ...
            <div class="phone">905-227-6060</div>
        </div>
        ...
        function hasScrolled() {
            ...
            if(width < 767) {
                ...
                if (st > lastScrollTop && st > navbarHeight){
                    // Scroll Down
                    $('#mc_embed_signup').removeClass('show').addClass('hide');
                } else {
                    // Scroll Up
                    if(st + $(window).height() < $(document).height()) {
                        $('#mc_embed_signup').removeClass('hide').addClass('show');
                    }
                }
